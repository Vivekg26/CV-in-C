# CV-in-C
This repository contains the implementation of a Computer Vision (CV) Library in C under the project offered by Stamatics, IITK (based on the online course by pjreddie).
...
[Homework 1: Fun with Color!] based on
...
[Homework 2: Resizing and Filtering] based on
